...
def generate_cats_comparison(cat1_species, cat2_species, keep_percentage):
    ...
    category1 = [sex_text, age_text, number_text, accommodation_text, area_text, exterior_text, observation_text]

    category2 = [shyness_text, calmness_text, afraid_text, clever_text, vigilant_text, persevering_text, affectionate_text, friendly_text, lonely_text,
    ...
    def generate_category_text(category, introduction_text):
        ...
        remaining_texts = category[:]
        selected_text = random.choice(remaining_texts)
        remaining_texts.remove(selected_text)

        selected_texts = [text for text in remaining_texts if random.random() <= keep_percentage]

        selected_texts.insert(0, selected_text)
